...
func CriarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if erro = usuario.CheckDataRules("cadastro"); erro != nil {
		respostas.Erro(w, http.StatusResetContent, erro)
		return
	}
...
func BuscarUsuarios(w http.ResponseWriter, r *http.Request) {
	...
	repositorio := repositorios.NovoRepositorioUsuarios(db)
	usuarios, err := repositorio.BuscarUsuarios(nomeOuNick)
	if err != nil {
		respostas.Erro(w, http.StatusInternalServerError, err)
		return
	}
...
func BuscarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	repositorio := repositorios.NovoRepositorioUsuarios(db)
	usuarios, err := repositorio.BuscarUsuarioID(usuarioID)
	if err != nil {
		respostas.Erro(w, http.StatusInternalServerError, err)
		return
	}
...
func AtualizarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if erro = usuario.CheckDataRules("edicao"); erro != nil {
		respostas.Erro(w, http.StatusResetContent, erro)
		return
	}
...
func SeguirUsuario(w http.ResponseWriter, r *http.Request) {
	...
	usuarioID, erro := strconv.ParseUint(variables["usuarioId"], 10, 64)
	if erro != nil {
		respostas.Erro(w, http.StatusBadRequest, erro)
		return
	}
	...
	if usuarioID == seguidorID {
		respostas.Erro(w, http.StatusForbidden, errors.New("Não é possível seguir a sí mesmo."))
		return
	}
...
func PararDeSeguirUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioID == seguidorID {
		respostas.Erro(w, http.StatusForbidden, errors.New("Não é possível deixar de seguir a sí mesmo."))
		return
	}
